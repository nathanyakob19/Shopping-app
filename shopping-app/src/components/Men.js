...
const Men = () => {
  ...
  const handleImageClick = () => {
    navigate("/MenTshirt"); // Navigate to login page
  };
  const handleImageClick1 = () => {
    navigate("/Menshirt"); // Navigate to login page
  };
 const handleImageClick2 = () => {
    navigate("/MenJacket"); // Navigate to login page
  };
  const handleImageClick3 = () => {
    navigate("/MenPants"); // Navigate to login page
  };
  return (
    <div>
      <img
